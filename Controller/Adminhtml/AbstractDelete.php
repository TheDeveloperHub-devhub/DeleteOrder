...
namespace DeveloperHub\DeleteOrder\Controller\Adminhtml;
...
use DeveloperHub\DeleteOrder\Controller\Adminhtml\Order\Index;
...
abstract class AbstractDelete extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('DeveloperHub_DeleteOrder::delete_order');
    }
